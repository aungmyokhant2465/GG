...
@section('content')
    ...
    <div class="content-wrapper" >
        ...
        <section class="content-header">
            <h1>
                <span class="fa fa-plus-square-o"></span> New Post
            </h1>
            <ol class="breadcrumb">
        ...
        <section class="content" style=" padding-bottom: 100%;">
            <div class="page-header">
                <a href="{{route('posts')}}" class="btn btn-outline-info"><i class="fa fa-backward"></i> Posts</a>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-8 col-sm-offset-2 col-xs-12">
                        <form method="post" action="{{route('post.new')}}" enctype="multipart/form-data">
                            <div class="panel">
                                <div class="panel-heading"  style="background: mediumseagreen"><strong><i class="fa fa-plus-circle"></i> Add Post</strong></div>
                                <div class="panel-body">
                                    ...
                                    <div class="form-group has-feedback {{$errors->has('category')?'has-error':''}}">
                                        ...
                                        @foreach($cates as $c)
                                            <input type="radio" name="category" id="category" value="{{$c->id}}">{{$c->cate_name}}
                                        @endforeach<br>
                                ...
                                <div class="panel-footer text-right">
                                    <div class="form-group">
                                        <button class="btn btn-primary btn-lg" style="color: black"> Post </button>
                                        {{csrf_field()}}
                                    </div>
                                </div>
                            </div>
